...
function Eventpage() {
  ...
  if (windowWidth > 1000) {
    return (
      <div className="overflow-x-hidden flex flex-col">
        {skipLink}
        <Navbar />
        <main id="main-content" ref={mainRef} tabIndex={-1} className="h-[100%] w-full bg-[#0b0b0c] overflow-hidden flex flex-col justify-center items-center gap-7 p-10 pt-28">
          {heading}
  ...
  return (
    <div className="bg-[#0b0b0c] min-h-screen">
      {skipLink}
      <Navbar />
      <main id="main-content" ref={mainRef} tabIndex={-1} className="flex justify-center items-center flex-col bg-[#0b0b0c] pt-24 max-[767px]:pt-[15vh]">
        {heading}
        {eventsList.map((event, index) => (
