  ...
  return ReactDOM.createPortal(
    <>
      <div
        ...
        onClick={onClose}
      />
      <div className='w-[70vh] h-[70vh] min-[700px]:w-[80vh] min-[700px]:h-[80vh] flex items-center justify-center fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-black rounded-xl p-16 z-50 shadow-slate-700 drop-shadow-lg shadow-2xl'>
        <Swiper
        ...
        >
          {images.map((url, index) => (
            <SwiperSlide key={index} className='rounded-full flex justify-center'>
              <img
                className='h-full w-full rounded-xl ease-in-out duration-200'
                src={url}
                alt={`Slide ${index + 1}`}
              />
            </SwiperSlide>
