  ...
  return (
    <div className='HeroSection relative bg-transparent overflow-x-hidden h-screen cursor-none' ref={myRef}>
      ...
      <div className={`hero ${showNotifications ? 'blur-sm' : ''}`}>
        ...
        <img src="././src/assets/Notification.png" alt="Notif" className={`Notif h-[26vh] absolute translate-y-44 right-0 cursor-pointer max-[767px]:bottom-12 max-[767px]:z-0 ${showNotifications?'hidden':''}`} onTouchStart={handleImageClick} onClick={handleImageClick} /> 
      </div>
