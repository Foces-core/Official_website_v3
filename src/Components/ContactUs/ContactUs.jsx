...
function ContactUs() {
  ...
  const sendEmail = (e) => {
    ...
    const serviceId = import.meta.env.VITE_EMAILJS_SERVICE_ID || "service_3uyk8ra";
    const templateId = import.meta.env.VITE_EMAILJS_TEMPLATE_ID || "template_mpsi88p";
    const publicKey = import.meta.env.VITE_EMAILJS_PUBLIC_KEY || "hbZttVeeBI9zfYmCc";
