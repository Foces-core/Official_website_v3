...
| `pnpm lint:workflows` | [actionlint](https://github.com/rhysd/actionlint) workflow linter + [shellcheck](https://github.com/koalaman/shellcheck) shell-injection checks (also runs in the pre-push hook)                                                                                                                                                                                                                                                                                                                                           |
