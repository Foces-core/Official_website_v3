...
| `pnpm knip`         | [knip](https://knip.dev/) dead-code / unused-dependency guard                                                                                                                                                                                                                                                                                                                                                                                                                                                              |     | `pnpm lint:workflows` | [actionlint](https://github.com/rhysd/actionlint) workflow linter + [shellcheck](https://github.com/koalaman/shellcheck) shell-injection checks (runs in the pre-push hook and CI) |
